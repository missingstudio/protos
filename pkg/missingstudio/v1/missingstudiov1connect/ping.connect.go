...
package missingstudiov1connect

import (
	connect "connectrpc.com/connect"
	context "context"
	errors "errors"
	v1 "github.com/missingstudio/protos/pkg/missingstudio/v1"
	http "net/http"
	strings "strings"
)
...
const (
	...
	PingServiceName = "missingstudio.v1.PingService"
)
...
const (
	...
	PingServicePingProcedure = "/missingstudio.v1.PingService/Ping"
)

// These variables are the protoreflect.Descriptor objects for the RPCs defined in this package.
var (
	pingServiceServiceDescriptor    = v1.File_missingstudio_v1_ping_proto.Services().ByName("PingService")
	pingServicePingMethodDescriptor = pingServiceServiceDescriptor.Methods().ByName("Ping")
)

// PingServiceClient is a client for the missingstudio.v1.PingService service.
type PingServiceClient interface {
	Ping(context.Context, *connect.Request[v1.PingRequest]) (*connect.Response[v1.PingResponse], error)
}

// NewPingServiceClient constructs a client for the missingstudio.v1.PingService service. By
...
// Ping calls missingstudio.v1.PingService.Ping.
...
// PingServiceHandler is an implementation of the missingstudio.v1.PingService service.
...
func NewPingServiceHandler(svc PingServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/missingstudio.v1.PingService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedPingServiceHandler) Ping(context.Context, *connect.Request[v1.PingRequest]) (*connect.Response[v1.PingResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("missingstudio.v1.PingService.Ping is not implemented"))
}
