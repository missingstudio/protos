...
import (
	...
	context "context"
	errors "errors"
	v1 "github.com/missingstudio/protos/pkg/llm/v1"
...
type LLMServiceClient interface {
	...
	StreamChatCompletions(context.Context, *connect.Request[v1.ChatCompletionRequest]) (*connect.ServerStreamForClient[httpbody.HttpBody], error)
...
func NewLLMServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) LLMServiceClient {
	...
	return &lLMServiceClient{
		...
		streamChatCompletions: connect.NewClient[v1.ChatCompletionRequest, httpbody.HttpBody](
			httpClient,
...
type lLMServiceClient struct {
	...
	streamChatCompletions *connect.Client[v1.ChatCompletionRequest, httpbody.HttpBody]
...
func (c *lLMServiceClient) StreamChatCompletions(ctx context.Context, req *connect.Request[v1.ChatCompletionRequest]) (*connect.ServerStreamForClient[httpbody.HttpBody], error) {
...
type LLMServiceHandler interface {
	ChatCompletions(context.Context, *connect.Request[v1.ChatCompletionRequest]) (*connect.Response[v1.ChatCompletionResponse], error)
	StreamChatCompletions(context.Context, *connect.Request[v1.ChatCompletionRequest], *connect.ServerStream[httpbody.HttpBody]) error
	ListModels(context.Context, *connect.Request[v1.ModelRequest]) (*connect.Response[v1.ModelResponse], error)
	ListProviders(context.Context, *connect.Request[emptypb.Empty]) (*connect.Response[v1.ListProvidersResponse], error)
	CreateProvider(context.Context, *connect.Request[v1.CreateProviderRequest]) (*connect.Response[v1.CreateProviderResponse], error)
	GetProvider(context.Context, *connect.Request[v1.GetProviderRequest]) (*connect.Response[v1.GetProviderResponse], error)
...
func (UnimplementedLLMServiceHandler) StreamChatCompletions(context.Context, *connect.Request[v1.ChatCompletionRequest], *connect.ServerStream[httpbody.HttpBody]) error {
